...
MARKETING_EMAIL_SEND_DELAY_MIN_SECONDS = int(os.getenv("MARKETING_EMAIL_SEND_DELAY_MIN_SECONDS", "5"))
MARKETING_EMAIL_SEND_DELAY_MAX_SECONDS = int(os.getenv("MARKETING_EMAIL_SEND_DELAY_MAX_SECONDS", "20"))
